...
def uncertainty_co2_per_capita(data, year, k):
    ...
    uncertainty_prediction = {country: (0.0, 0.0, 0.0) for country in uncertainty['country'].unique()} #set the every country prediction to 0.0 to prevent any drop of a country during the data filtering
